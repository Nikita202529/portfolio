...
<head>
	...
	<meta name="description" content="Техническая поддержка и доработка сайтов на 1С-Битрикс. Разовая и постоянная техподдержка с гарантией. Пакетные депозиты со скидкой до 30%. Аутсорс и аутстаффинг. Специальные предложения для студий и агентств.">
	<meta name="keywords" content="поддержка сайта 1С-Битрикс, доработка сайта 1С-Битрикс, постоянная техподдержка сайта, сопровождение сайта Битрикс, разработка битрикс, программист битрикс, Битрикс, bitrix, аутстаф разработчик 1С-Битрикс, 1c-bitrix.ru">

	<meta property="og:title" content="Перенос сайта на «1С-Битрикс»">
	<meta property="og:type" content="article">
	<meta property="og:description" content="Техническая поддержка и доработка сайтов на 1С-Битрикс. Разовая и постоянная техподдержка с гарантией. Пакетные депозиты со скидкой до 30%. Аутсорс и аутстаффинг. Специальные предложения для студий и агентств." />
	...
	<title>Поддержка сайтов на 1С-Битрикс - от 1800 руб</title>
	...
	<script type="application/ld+json">
		{
			...
			"offers": [{
					"@type": "Offer",
					"name": "Главный модуль",
					"description": "Готовая интеграция из коробки.",
					"priceCurrency": "RUB"
				},
				{
					"@type": "Offer",
					"name": "Многоскладовость",
					"description": "Возможность показывать остатки товаров в каждом магазине отдельно.",
					"priceCurrency": "RUB"
				},
				{
					"@type": "Offer",
					"name": "Поддержка работы с SKU (Stock Keeping Unit)",
					"description": "Добавление на товар разных ценовых предложений в зависимости от свойств или характеристик.",
					"priceCurrency": "RUB"
				},
				{
					"@type": "Offer",
					"name": "Выгрузка каталогов товаров в 1С",
					"description": "Импортирование каталогов с сайта для ведения учёта в «1С: Управление торговлей».",
					"priceCurrency": "RUB"
				},
				{
					"@type": "Offer",
					"name": "Построение дерева каталогов",
					"description": "Формирование новой структуры сайта без переделки справочника номенклатуры.",
					"priceCurrency": "RUB"
				},
				{
					"@type": "Offer",
					"name": "Мультиканальность взаимодейтсвия с клиентом",
					"description": "Офлайн и онлайн заказы можно отслеживать на сайте.",
					"priceCurrency": "RUB"
				},
				{
					"@type": "Offer",
					"name": "Оптимизация загрузки/выгрузки",
					"description": "Обмен данными для снижения нагрузки на интернет-канал, сайт и «1С».",
					"priceCurrency": "RUB"
				},
				{
					"@type": "Offer",
					"name": "Синхронизация справочников",
					"description": "Справочники из «1С» можно загрузить на сайт.",
					"priceCurrency": "RUB"
				}
			]
		}
...
<body>
	...
	<div class="wrap">
			...
			<div class="container-fluid pl-0 pr-0 h-100">
				<div class="row no-gutters h-100">
					<div class="col-12">
						...
						<ul class="menu-list">
							<li class="menu-item">
								<a href="#highlights" class="menu-link btn-scroll">
									Что мы предлагаем
								</a>
							</li>
							<!-- li -->
							<li class="menu-item">
								<a href="#when_to_move" class="menu-link btn-scroll">
									Рекомендации
								</a>
							</li>
							<!-- li -->
							<li class="menu-item">
								<a href="#advantages" class="menu-link btn-scroll">
									Преимущества «1С-Битрикс»
								</a>
							</li>
							<!-- li -->
							<li class="menu-item">
								<a href="#costOfWork" class="menu-link btn-scroll">
									Тарифы
								</a>
							</li>
							<!-- li -->
							...
							<!-- li -->
							<li class="menu-item">
								<a href="#questions" class="menu-link btn-scroll">
									Вопросы
								</a>
							</li>
							<!-- li -->
		...
		<div class="scrollcontent">
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-6 col-sm-8 col-md-6 col-lg-8 d-flex justify-content-end align-items-center">
							<a class="header-phone header-phone__mhidden" href="tel:88002011904">8-800-201-19-04</a>
							<a class="header-btn button forCalcModal" href="" data-toggle="modal" data-target="#calculateTheCostModal">Оценить задачу</a>
						</div>
					</div>
					<!-- /.row -->
				</div>
			...
			<div id="highlights" class="highlights gray_bg">
				<div class="container">
						...
						<div class="col-12 row d-flex justify-content-between">
							<div class="col-12	col-lg-6">
								...
								<div class="highlights_techsupport">
									<h1>
										<b>
											Перенос сайта на <br> «1С-Битрикс»
										</b>
									</h1>
								</div>
								<div class="col-12 d-block d-lg-none site_photo">
									<img src="./img/site.png" alt="Перенос сайта на «1С-Битрикс»">
								</div>
								<div class="highlights_list_wrapper">
									<ul class="highlights_list">
										<li class="highlights_list_item">CRM для создания и продвижения веб-проектов любого вида.</li>
										<li class="highlights_list_item">Совместимость с «1C:Предприятие» и «МойСклад».</li>
										<li class="highlights_list_item">Высокий уровень защищенности от взлома и кражи информации.</li>
									</ul>
								</div>
								<div class="highlights_btn_wrapper">
									<a class="button btn-scroll highlights_btn" href="#costOfWork">Выбрать тариф</a>
								</div>
							</div>
							<div class="col-6 d-none d-lg-block site_photo">
								<img src="./img/site.png" alt="Перенос сайта на «1С-Битрикс»">
							</div>
						</div>
					</div>
			...
			<section id="when_to_move" class="support-services">
				<a name="support-services"></a>
				<!--якорь-->
				<div class="container">
					<div class="row align-items-center">
						<div class="col-12">
							<div class="support-services-bg title-bg">When to Move</div>
							<div class="title-before support-title-before">Когда переезжать на «1С-Битрикс»</div>
							<h2 class="title support-services__title">Рекомендации</h2>
						</div>
					</div>
					<!-- /.row -->
							...
							<?php foreach ($data->all_support_services as $value) { ?>
								<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 d-flex">
									<div class="service-item d-flex">
										<object data="./img/check.png" type="image/svg+xml" class="service-item_img">
											<img src="./img/check.png" alt="<?= $value->title ?>">
										</object>
										<div class="">
			...
			<section id="advantages" class="support-services">
				<a name="support-services"></a>
				<!--якорь-->
				<div class="container">
					<div class="row align-items-center">
						<div class="col-12">
							<div class="support-services-bg title-bg">Advantages</div>
							<div class="title-before support-title-before">Преимущества сайтов на «1С-Битрикс»</div>
							<h2 class="title support-services__title">Почему «1С-Битрикс»?</h2>
						</div>
					</div>
					<!-- /.row -->
					<div class="service-items__scroll">
						<div class="row align-items-start d-inline-flex d-sm-flex flex-nowrap flex-sm-wrap overflow-hidden">
							<?php foreach ($data->all_advantages as $value) { ?>
								<div class="col-sm-4 col-md-4 col-lg-3 col-xl-3 d-flex justify-content-center justify-content-lg-start d-inline-flex">
									<div class="service-item_advantages">
			...
			<section id="costOfWork" class="support ">
				<a name="support"></a>
				<!--якорь-->
				<div class="container">
					<div class="row">
						<div class="col-xl-12">
							<div class="support-bg title-bg">COST OF WORK</div>
							<div class="title-before support-title-before">СТОИМОСТЬ ЧАСОВ РАЗРАБОТЧИКОВ</div>
							<h2 class="title support-title">Тарифы</h2>
						</div>
					</div>
					<div class="row align-items-center">
						<div class="col-12 col-lg-7 col-xl-7">
							<div class="support-desc">
								<div class="title-desc d-flex align-items-center">
									Настройка выгрузки товаров и обмена с «1C»
								</div>
								<div class="title-desc d-flex align-items-center">
									Настройка обмена с нестандартными конфигурациями
								</div>
							</div>
						</div>
							...
							<div class="support-desc">
								<div class="support-price">
									<div class="support-price_name">
										<span>от</span>1800<span class="ruble_price">&#8381;</span><span>/час</span>
									</div>
								</div>
							</div>
						</div>
			...
			<section id="recommend" class="recommend gray_bg">
				...
				<div class="container">
					<div class="row">
						<div class="col-12">
							<div class="recommend-bg title-bg white_font">Stages of Transfer</div>
							<div class="title-before support-title-before">Этапы переноса сайта на «1С-Битрикс»</div>
							<h2 class="title support-services__title">Алгоритм работы по переносу сайта</h2>
						</div>
						<!-- /.col-12 -->
							...
							<div class="work-process">
								...
								<div class="wp-tree">
									...
									<div class="wp-cell">
										...
										<div class="wprocess-step">Изучение ситуации</div>
										<div class="wprocess-desc">
											Определяем хостинг сайта, какие
											страницы необходимо сохранить в
											первую очередь
										</div>
									</div>
									...
									<div class="wp-cell">
										...
										<div class="wp-line"></div>
										<div class="wprocess-step">Подбор хостинга</div>
										<div class="wprocess-desc">
											Поможем с выбором шаблона, если
											возникнут сложности
										</div>
									</div>

									<div class="wp-cell">
										<div class="wp-cell-bg text-bg white_font">План</div>
										<div class="wprocess-number">3</div>
										<div class="wp-line"></div>
										<div class="wprocess-step">Составление ТЗ</div>
										<div class="wprocess-desc">
											Обговариваем и описываем все,
											что нужно будет сделать
										</div>
									</div>

									<div class="wp-cell">
										<div class="wp-cell-bg text-bg white_font">Перенос</div>
										<div class="wprocess-number">4</div>
										<div class="wp-line"></div>
										<div class="wprocess-step">Перенос сайта</div>
										<div class="wprocess-desc">
											Оказываем услуги по переносу
										</div>
									</div>
									...
									<div class="wp-cell">
										...
										<div class="wp-line"></div>
										<div class="wprocess-step">Постпроектные работы</div>
										<div class="wprocess-desc">
											Через неделю проверяем
											индексацию сайта. Не должно быть
											просадок по трафику или в
											поисковой выдаче
										</div>
									</div>
								</div>
			...
			<section id="questions" class="subscription">
				<a name="subscription"></a>
				<!--якорь-->
				<div class="container">
					<div class="row mb-4">
						<div class="col-xl-12">
							<div class="subscription-bg title-bg">Questions</div>
							<div class="title-before subscription-title-before"></div>
							<br>
							<h2 class="title subscription-title">ОСТАЛИСЬ ВОПРОСЫ?</h2>
						</div>
					</div>
					<div class="row questions p-4">
						<div class="col-12 col-lg-6 col-xl-6">
							<div class="subscription-advant advantWrapperForDestcMonth">
								<div class="subscription-advant__title">
									<h3>
										ЗАКАЗАТЬ КОНСУЛЬТАЦИЮ ПО ПО ПЕРЕНОСУ САЙТА НА «1С-БИТРИКС»
									</h3>
								</div>
								<p>
									Остались вопросы по переносу сайта на «1С-Битрикс»? Наши специалисты готовы провести для Вас
									бесплатную презентацию и ответить на них. Заполните анкету ниже, и мы проведем консультацию с
									учётом ваших требований к порталу.
								</p>
								<div class="subscription-advant__title">
									<h3>
										ЧТО УЗНАЕТЕ ИЗ КОНСУЛЬТАЦИИ
									</h3>
								</div>
								<p>
									1. Если Вы ещё не знакомы с «1С-Битрикс», наш
									менеджер расскажет о преимуществах CRM,
									учитывая специфик бизнеса. Поможем подобрать
									шаблон, составим ТЗ, обсудим нюансы
									сотрудничества.
								</p>
								<p>
									2. Если Вы уже работали с CRM, но хотите перенести
									сайт по своим причинам - подберём готовое
									решение, поможем с выбором оптимального
									тарифа, подготовим подробное ТЗ.
								</p>
							</div>
						...
						<div class="col-12 col-lg-6 col-xl-6">
							<h3 class="text-center my-3">Оставить заявку</h3>
							<form action="" id="popup_form_Typical" class="popup-form__form" method="POST">
								<div class="popup-form-box">
									<div class="Flying_Placeholder">
										<label>Имя *</label>
										<input class="popup-form-box__input" type="text" name="user-name_request" id="user-name_request">
									</div>
									<div class="Flying_Placeholder">
										<label>Телефон</label>
										<input class="popup-form-box__input" type="tel" name="user-phone_request" id="user-phone_request">
										<select id="popup-form-contact_way_request" name="popup-form-contact_way_request" class="contact_way">
									...
									<div class="Flying_Placeholder">
										<label>Вид деятельности, регион, сайт организации</label>
										<textarea class="calculation-form__input calculation-form__ta" name="comments"></textarea>
									</div>
								</div>
								<div class="popup-form-desc d-flex align-items-center justify-content-between mb-3">
									<img src="./img/CheckboxCheck.svg" alt="" class="me-3">
									<p class="mb-0">Нажимая на кнопку, я даю согласие на передачу личных данных ФЗ РФ №152 «О защите персональных данных»</p>
								</div>
								...
								<div class="popup-form-desc mt-3">
									<p>
										<b>
											Чего мы точно не будем делать? Мы не будем
											использовать Ваши контактные данные для
											рассылки спама.
										</b>
									</p>
								</div>
				...
				<div class="popup-form">
					<div class="popup-form-header" id="ModalLongTitle">
						...
						<div class="popup-form-header__descr">Заполните, пожалуйста, форму. Чем больше будет информации о задаче, тем точнее мы сможем её оценить.
							Возможно, мы свяжемся с Вами для уточнения деталей. Результат оценки мы пришлём вам на указанную почту.
							В зависимости от сложности задачи оценка занимает от 15 минут до 2-х дней. Срочные задачи обслуживаются вне очереди</div>
						<button type="button" class="popup-close close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					...
					<form action="" id="collaboration_form" class="popup-form__form" method="POST">
						<div class="row">
							...
							<div class="col-12 col-sm-12 col-md-6 col-lg-6">
								...
								<div class="Flying_Placeholder">
									<select name="proj_types" id="proj_types" class="S3_type_1 S3_fixedUp">
								...
								<div class="Flying_Placeholder">
									<select name="type_of_coop" id="type_of_coop" class="S3_type_1 S3_fixedUnder">
										<option value="Аутстафинг">Аутстафинг</option>
								...
								<div class="calculation-form__checkbox off_margin_bott d-inline-flex align-items-center">
									<div>
								...
								<div class="calculation-form__checkbox d-inline-flex align-items-center ">
									...
									<div class="Flying_Placeholder hidden_client">
										<label>ID клиента *</label>
										<input class="popup-form-box__input" name="id_client_collabForm" id="id_client_collabForm">
									</div>
		...
		<div class="send-request modal fade" id="firstMonthModal" tabindex="-1" role="dialog" aria-labelledby="ModalLongTitle" aria-hidden="true">
			<div class="popup modal-dialog m-0" role="document">
				...
				<div class="popup-form">
					<div class="popup-form-header" id="ModalLongTitle">
						<div class="popup-form-header__title">Закажи техподдержку на год и получи тестовый период на 1 мес*</div>
